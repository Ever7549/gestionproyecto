            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Listado de Tutores</h6>
                                ...
                                if (!empty($tutores)) { ?>
                                    <?php foreach ($tutores as $tutor) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $tutor->profesion; ?></td>
                                            <td><?php echo $tutor->nombre; ?></td>
                                            <td><?php echo $tutor->primerApellido; ?></td>
                                            <td><?php echo $tutor->segundoApellido; ?></td>
                                            <td>
                                                <a href="<?php echo site_url('Tutor_c/modificar/'.$tutor->id); ?>" class="btn btn-warning">
                    ...
                    <div class="mt-4">
                        ...
                        <a href="<?php echo base_url(); ?>index.php/tutor_c/agregar" class="btn btn-primary">Agregar Tutor</a>
                    </div>
                </div>
            </div>
