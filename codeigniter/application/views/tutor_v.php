            ...
            <div class="col-12">
                <div class="bg-secondary rounded h-100 p-4">
                    <nav class="navbar navbar-expand-lg navbar-light mb-4">
                        <a class="navbar-brand" href="#">Gestiónar Tutores</a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo base_url(); ?>index.php/tutor_c/agregar">
                                        <button type="button" class="btn btn-primary">Agregar Tutor</button>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <h6 class="mb-4">Listado de Tutores</h6>
                                ...
                                if (!empty($tutores)) { ?>
                                    <?php foreach ($tutores as $tutor) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $tutor->apellidos; ?></td>
                                            <td><?php echo $tutor->nombre_carrera; ?></td> <!-- Mostrando el nombre de la carrera -->
                                            <td><?php echo $tutor->nombre_rol; ?></td> <!-- Mostrando el nombre del rol -->
                                            <td>
                                                <a href="<?php echo site_url('Tutor_c/modificar/'.$tutor->idtutor); ?>" class="btn btn-warning">
                                                    <i class="bi bi-pencil-square"></i> Modificar
                                                </a>
                                            </td>
                                            <td>
                                                <form action="<?php echo site_url('Tutor_c/eliminarbd'); ?>" method="post" style="display:inline;">
                                                    <input type="hidden" name="idTutor" value="<?php echo $tutor->idtutor; ?>">
