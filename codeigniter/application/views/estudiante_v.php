            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                                ...
                                if (!empty($estudiantes)) { ?>
                                    <?php foreach ($estudiantes as $estudiante) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $estudiante->estudiante_info; ?></td>
                                            ...
                                            <td>
                                                <a href="<?php echo site_url('Estudiante_c/modificar/'.$estudiante->id); ?>" class="btn btn-warning">
                                                    <i class="bi bi-pencil-square"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <form action="<?php echo site_url('Estudiante_c/eliminarbd'); ?>" method="post" style="display:inline;">
                    ...
                    <div class="mt-4">
                        ...
                        <a href="<?php echo site_url('Estudiante_c/agregar'); ?>" class="btn btn-primary"><i class="bi bi-plus"></i> Agregar Proyecto</a>      
                    </div>
                </div>
            </div>
