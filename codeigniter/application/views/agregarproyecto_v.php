            ...
            <?php echo form_open("Proyecto_c/agregarbd"); ?>
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <select class="form-select" id="estadov" name="estadov" required>
                    <option value="1" <?php echo isset($infoproyecto) ? ($infoproyecto->estado == '1' ? 'selected' : '') : 'selected'; ?>>Activo</option>
                    <option value="0" <?php echo isset($infoproyecto) && $infoproyecto->estado == '0' ? 'selected' : ''; ?>>Inactivo</option>
                  </select>
                </div>
                <div class="col-md-6">
