...
class Modalidad_c extends CI_Controller {
    ...
    {
        $this->load->model('Modalidad_model');
        $this->Modalidad_model->eliminar_modalidad($idmodalidad); // Eliminar el proyecto usando el modelo
        redirect('Modalidad_c/listar', 'refresh'); // Redireccionar a la lista de proyectos
    }
    ...
    public function eliminarbd()
    {
        ...
        $this->load->model('Modalidad_model');
        $this->Modalidad_model->eliminar_modalidad($idModalidad); // Llamar al método de eliminación en el modelo
        redirect('Modalidad_c/listar', 'refresh'); // Redireccionar a la lista de proyectos
    }
    ...
    public function modificar($idmodalidad) 
    {
        // Obtener los datos del tutor por ID
        $data['infomodalidad'] = $this->Modalidad_model->recuperar_modalidad($idmodalidad);
        // Cargar la vista
    ...
    public function modificarbd()
    {
        ...
        $this->Modalidad_model->modificar_modalidad($idmodalidad, $data);
